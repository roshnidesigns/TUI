/*
 * Social Battery — the motorized fader, plus one servo arm (D7)
 * Tangible User Interface, CIID
 *
 * The fader below is untouched from FRESH-TRY-SPEED-MS. Added on top: a single
 * servo arm on D7, driven independently on its own LOW/MED/HIGH levels - not yet
 * synced to the fader's pace, that's a later step.
 *
